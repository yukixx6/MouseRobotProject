...
5.Design the circuit. The circuit below uses an inverter IC with pull down resistors. The robot will move toward the shadow. This is only one example of a circuit and it can be customize freely. Example circuits can be found in the circuit folder.
